...
return [
     ...
     *
     * >>>>>>>>>>>>>>>>>>>>>> NB Set empty array to disable notifications <<<<<<<<<<<<<<<<<<<<<<<<<<<
     *
     */
    'notifications' => [
        'notifications' => [
        ...
        'mail' => [
            'to' => 'hello@rentalflow.cloud',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'noreply@ml.rentalflow.cloud'),
                'name' => env('MAIL_FROM_NAME', 'BK - repos.rentalflow.cloud'),
            ],
        ],
    ...
    'monitor_backups' => [
        [
            ...
            'disks' => ['s3'],
            'health_checks' => [
                \Spatie\Backup\Tasks\Monitor\HealthChecks\MaximumAgeInDays::class => 375,
                \Spatie\Backup\Tasks\Monitor\HealthChecks\MaximumStorageInMegabytes::class => 2500000,
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_daily_backups_for_days' => 12,
